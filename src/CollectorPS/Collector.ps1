...
[System.Collections.ArrayList]$tempFile = (("'This file has been auto-generated by Ilogic Collector - version " + $version), ("'Collection timestamp: " + (get-date -Uformat "%Y/%m/%d - %R")), "'https://github.com/jordanrobot/iLogicCollector","")
